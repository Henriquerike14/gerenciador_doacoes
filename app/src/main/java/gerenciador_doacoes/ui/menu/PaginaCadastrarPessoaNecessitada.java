...
public class PaginaCadastrarPessoaNecessitada {
    ...
    public void exibir() {
        ...
        System.out.print("Digite o tipo de pedido (1 - Alimento, 2 - Material de Higiene, 3 - Material de Limpeza): ");
        int tipo = scanner.nextInt();

        System.out.print("Digite a quantidade necessitada: ");
